    ...
    <header class="page-topbar" id="header">
        <div class="navbar navbar-fixed"> 
            ...
            <div class="nav-wrapper">
                <div class="header-search-wrapper hide-on-med-and-down" style="display:none;"><i class="material-icons">search</i>
                ...
                <li><a class="grey-text text-darken-1" href="index.php"><i class="material-icons">keyboard_tab</i> Cerrar sesión</a></li>
                </ul>
            </div>
