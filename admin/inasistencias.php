                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Registro de inasistencias</span></h5>
                            <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="main.php">Home</a>
                            </li>                  
                            <li class="breadcrumb-item active">Inasistencias
                            </li>
                            </ol>
                        </div>
...
>
    ...
    <div id="modalInasistencia" class="modal modal-fixed-footer">
        <div class="modal-content">
            ...
            <form id="form-inasistencia">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="txtFecha" name="txtFecha" type="text" class="datepicker">
                    </div>
                </div>                  
            </form>
        </div>
...
<script src="app-assets/js/app/inasistencias.js"></script>
