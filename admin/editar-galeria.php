...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-gradient-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-gradient-menu" data-col="2-columns">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Editar Galería</span></h5>
                        </div>
    ...
    <div id="modalDescImagen" class="modal modal-fixed-footer">
        ...
        <div class="modal-footer">
            <a id="btnGuardarGaleria" href="#" class="modal-action waves-effect waves-red btn-flat ">Guardar</a>
    ...
    <script src="app-assets/js/app/editar-galeria.js"></script>
    <!-- END PAGE LEVEL JS-->
</body>
