                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Listado de préstamos</span></h5>
                            <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="main.php">Home</a>
                            </li>                  
                            <li class="breadcrumb-item active">Préstamos
                            </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6">
                            <a id="add_prestamo" href="#modalPrestamo" class="waves-effect waves-light breadcrumbs-btn right btn modal-trigger" style="display:block;">AGREGAR</a>
...
<!-- END: Page Main-->
    ...
    <!-- MODALS -->
    <div id="modalPrestamo" class="modal modal-fixed-footer">
        ...
        <form id="form-prestamo">
            ...
            <div class="row">
                <div class="input-field col s5">
                    <select id="slTipoPrestamo" name="slTipoPrestamo">
                        <option value="" disabled selected>Seleccione</option>
                        <option value="A">Adelanto Semana</option>
                        <option value="G">Préstamo Global</option>                    
                    </select>
                    <label>Tipo Préstamo</label>
                </div>
                <div class="input-field col s7">
                    <input placeholder="" id="txtDescPrestamo" name="txtDescPrestamo" type="text" maxlength="120">
                    <label for="txtDescPrestamo" class="active">Descripción préstamo</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                    <input id="txtFecha" name="txtFecha" type="text" placeholder="Fecha préstamo" class="datepicker">
                </div>
            </div>              
            <div class="row">
                <div class="input-field col s6">
                    <input placeholder="" id="txtMontoPrestamo" name="txtMontoPrestamo" type="text" maxlenngth="14">
                    <label for="txtMontoPrestamo" class="active">Monto Préstamo</label>
                </div>                
            </div>                                           
        </form>
    </div>
    ...
    <script src="app-assets/js/app/prestamos.js"></script>
