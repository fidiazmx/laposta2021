                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Historial trabajos terminados</span></h5>
                        </div>
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="main.html">Administración</a>
                                </li>
                                <li class="breadcrumb-item active">Historial trabajos terminados
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="col s12 m12 l12">
                                <div id="button-trigger" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        <a id="add_cliente" href="#modalCliente" class="waves-effect waves-light btn mb-1 mr-1 modal-trigger" style="display:block;">AGREGAR</a>
