                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Empleados</span></h5>
                        ...
                        <div class="col s2 m6 l6">
                            <a id="add_empleado" href="#modalEmpleado" class="waves-effect waves-light breadcrumbs-btn right btn modal-trigger" style="display:block;">AGREGAR</a>
...
<div id="modalEmpleado" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <form id="form-empleados">
            <div class="row">
                <div class="input-field col s12">
                    <input placeholder="" id="txtNombre" name="txtNombre" type="text" maxlength="120">
                    <label for="txtNombre" class="active">Nombre</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s6">
                    <input placeholder="" id="txtTelefono" name="txtTelefono" type="text" maxlength="10">
            ...
            <div class="row">
                <div class="input-field col s4">
                    <input placeholder="" id="txtAdeudo" name="txtAdeudo" type="text" maxlenngth="14">
                    <label for="txtAdeudo" class="active">($) Adeudo</label>
                </div>
                <div class="input-field col s4">
                    <input placeholder="" id="txtSueldo" name="txtSueldo" type="text" maxlenngth="14">
                    <label for="txtSueldo" class="active">($) Sueldo</label>
                </div>
                <div class="col s4">
...
<script src="app-assets/js/app/empleados.js"></script>
