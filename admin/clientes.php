                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Catálogo Clientes (Direcciones)</span></h5>
                            <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="main.html">Home</a>
                            </li>                  
                            <li class="breadcrumb-item active">Direcciones 
                            </li>
                            </ol>
                        </div>
                                            ...
                                            <!--<tr>
                                                ...
                                                <td>
                                                    <div class="invoice-action">
                                                        <a href="#" style="color: gray;" class="invoice-action-edit cambiaestado">
    ...
    <div id="modalCliente" class="modal modal-fixed-footer">
        <div class="modal-content">
            ...
            <form id="form-clientes">
                <div class="row">
                    <div class="input-field col s12">
                        <input placeholder="" id="txtNombre" name="txtNombre" type="text" placeholder="">
                        <label for="txtNombre" class="active">Nombre</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <input placeholder="" id="txtDireccion" name="txtDireccion" type="text" placeholder="">
                        <label for="txtDireccion" class="active">Dirección</label>
                    </div>
                </div>  
                <div class="row">
                    <div class="input-field col s6">
                        <input placeholder="" id="txtTelFijo" name="txtTelFijo" type="text" maxlength="10" placeholder="">
                        <label for="txtTelFijo" class="active">Tel.(Fijo)</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="" id="txtTelCel" name="txtTelCel" type="text" maxlength="10" placeholder="">
                        <label for="txtTelCel" class="active">Tel.(Cel)</label>
                    </div>
                </div>        
                <div class="row">
                    <div class="input-field col s12">
                        <select id="slMide" name="slMide">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <select id="slEmpleado" name="slEmpleado">
                            <option value="" disabled selected>Seleccione</option>
                            <option value="1">Option 1</option>
                            <option value="2">Option 2</option>
                            <option value="3">Option 3</option>
                ...
                <div id="contenedorPresupuesto" class="row" style="display:none;">
                    <div class="input-field col s3" >
                        <input id="txtPresupuesto" name="txtPresupuesto" placeholder="" type="text" value="0.00" class="validate">
                        <label for="txtPresupuesto" class="active">Presupuesto 1</label>
                    </div>
                    <div class="input-field col s3" >
                        <input id="txtPresupuesto2" name="txtPresupuesto2" placeholder="" type="text" value="0.00" class="validate">
                        <label for="txtPresupuesto2" class="active">Presupuesto 2</label>
                    </div>
                    <div class="input-field col s3" >
                        <input id="txtPresupuesto3" name="txtPresupuesto3" placeholder="" type="text" value="0.00" class="validate">
                        <label for="txtPresupuesto3" class="active">Presupuesto 3</label>
                    </div>
                    <div class="input-field col s3" >
                        <input id="txtPresupuesto4" name="txtPresupuesto4" placeholder="" type="text" value="0.00" class="validate">
                        <label for="txtPresupuesto5" class="active">Presupuesto 4</label>
                    </div>
                </div>                              
                <div class="row">
                    <div class="input-field col s12">
                        <input placeholder="" id="txtUbicacion" name="txtUbicacion" type="text" placeholder="">
                        <label for="txtUbicacion" class="active">Ubicación</label>
                    </div>
                </div>
            </form>
        </div>
        <div class="modal-footer">
            <a href="#" id="btnGuardar" class="modal-action waves-effect waves-red btn-flat ">Guardar</a>
            <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat ">Cancelar</a>
        </div>
    </div>

<?php include 'footer.php';?>
<script src="app-assets/js/app/clientes.js"></script>
