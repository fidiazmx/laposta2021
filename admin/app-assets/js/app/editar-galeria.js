$(document).ready(function(){
    ...
    $(document).on('click', 'a.function_edit', function(e){
        ...
        if ($(this).data('esvideo') == "A" ) {
            $("#txtUrlvideoYoutube").val($(this).data('url-video'));
            $("#swEsVideo").prop('checked', true);
            $("#swEsVideo").val('A');
        } else {
            $("#txtUrlvideoYoutube").val("");
            $("#swEsVideo").prop('checked', false);
            $("#swEsVideo").val('I');
        }
    ...
    $("#btnGuardarGaleria").click(function(){
        ...
        data:         form_data+'&swActivo='+$("#swActivo").val()+'&id='+sessionStorage.getItem("idgaleria")+'&swEsVideo='+$("#swEsVideo").val(),
        type:         'POST'
        //cache:        false,
        //dataType:     'json',
