                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Clientes en espera</span></h5>
                            <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="main.html">Home</a>
                            </li>                  
                            <li class="breadcrumb-item active">Clientes en espera 
                            </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6">
                            <!--<a id="add_trabajo" href="#modalTrabajo" class="waves-effect waves-light breadcrumbs-btn right btn modal-trigger" style="display:block;">AGREGAR</a>-->
                                    ...
                                    <table id="data-table-simple" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>1</td>                                               
                                                <td>Fidel Díaz Méndez</td>
                                                <td><a class="cambiaestado" href="#"><i class="material-icons dp48" style="color:red;">watch_later</i></a></td>                                                
                                                <td><a class="cambiaestado" href="#"><i class="material-icons dp48" style="color:yellow;">local_phone</i></a></td>
                                                <td><a class="cambiaestado" href="#"><i class="material-icons dp48" style="color:orange;">person</i></a></td>
                                                <td><a class="cambiaestadoaprobado" href="#"><i class="material-icons dp48" style="color:green;">check</i></a></td>                                                
                                                <td>2288523630</td>  
                                                <td>3000.00</td>  
                                                <td>2800.00</td>  
                                                <td>2600.00</td>  
                                                <td>2400.00</td>  
                                                <td>JJ CORONADO AGUACATAL</td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>2</td>                                               
                                                <td>Fidel Díaz Méndez</td>
                                                <td><a class="cambiaestado" href="#"><i class="material-icons dp48" style="color:gray;">watch_later</i></a></td>
                                                <td><a class="cambiaestado" href="#"><i class="material-icons dp48" style="color:gray;">local_phone</i></a></td>
                                                <td><a class="cambiaestado" href="#"><i class="material-icons dp48" style="color:gray;">person</i></a></td>
                                                <td><a class="cambiaestadoaprobado" href="#"><i class="material-icons dp48" style="color:gray;">check</i></a></td>
                                                <td>2288523630</td>  
                                                <td>3000.00</td>  
                                                <td>2800.00</td>  
                                                <td>2600.00</td>  
...
>
    ...
    <div id="modalTrabajo" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h6 class="card-title">Ingrese una descripción para generar el trabajo</h4>
            <form>
                <div class="row">
                    <div class="input-field col s12">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input placeholder="" id="txtDireccion" name="txtDireccion" type="text">
                        <label for="txtDireccion" class="active">Dirección</label>
                    </div>
                </div>  
                <div class="row">
                    <div class="input-field col s9">
                        <input placeholder="" id="txtPrecio1" name="txtPrecio1" type="text">
                        <label for="txtPrecio1" class="active">($) Precio 1</label>
                        <input type="hidden" id="txtPrecio" name="txtPrecio" value="0.00">
                    </div>
                    <div class="input-field col s3">
                        <label>
                            <input type="checkbox" class="filled-in checkboxpresupuesto" id="chkPresupSeleccionado1" name="chkPresupSeleccionado1" />
                            <span></span>
                        </label>
                    </div>
                </div>                    
                <div class="row">
                    <div class="input-field col s9">
                        <input placeholder="" id="txtPrecio2" name="txtPrecio2" type="text">
                        <label for="txtPrecio2" class="active">($) Precio 2</label>
                    </div>
                    <div class="input-field col s3">
                        <label>
                            <input type="checkbox" class="filled-in checkboxpresupuesto" id="chkPresupSeleccionado2" name="chkPresupSeleccionado2" />
                            <span></span>
                        </label>
                    </div>
                </div>    
                <div class="row">
                    <div class="input-field col s9">
                        <input placeholder="" id="txtPrecio3" name="txtPrecio3" type="text">
                        <label for="txtPrecio3" class="active">($) Precio 3</label>
                    </div>
                    <div class="input-field col s3">
                        <label>
                            <input type="checkbox" class="filled-in checkboxpresupuesto" id="chkPresupSeleccionado3" name="chkPresupSeleccionado3" />
                            <span></span>
                        </label>
                    </div>
                </div>    
                <div class="row">
                    <div class="input-field col s9">
                        <input placeholder="" id="txtPrecio4" name="txtPrecio4" type="text">
                        <label for="txtPrecio4" class="active">($) Precio 4</label>
                    </div>
                    <div class="input-field col s3">
                        <label>
                            <input type="checkbox" class="filled-in checkboxpresupuesto" id="chkPresupSeleccionado4" name="chkPresupSeleccionado4" />
                            <span></span>
                        </label>
                    </div>
                </div>                        
        ...
        <div class="modal-footer">
            <a id="btnGuardarTrabajo" href="#" class="modal-action waves-effect waves-red btn-flat ">Guardar</a>
            <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat ">Cancelar</a>
        </div>
    </div>

    <?php include 'footer.php';?>
<script src="app-assets/js/app/clientes-espera.js"></script>