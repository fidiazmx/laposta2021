                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Abonos cuenta</span></h5>
                            <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="main.php">Home</a>
                            </li>                  
                            <li class="breadcrumb-item active">Abonos cuenta
                            </li>
                            </ol>
                        </div>
                        <div class="col s2 m6 l6">
                            <a id="add_abono" href="#modalAbono" class="waves-effect waves-light breadcrumbs-btn right btn modal-trigger" style="display:block;">AGREGAR</a>
...
<!-- END: Page Main-->
    ...
    <!-- MODALS -->
    <div id="modalAbono" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <form id="form-abono">
            ...
            <div class="row">                
                <div class="input-field col s12">
                    <input placeholder="" id="txtDescAbono" name="txtDescAbono" type="text" maxlength="120">
                    <label for="txtDescAbono" class="active">Descripción abono</label>
                </div>
            </div>
            <div class="row">                
                <div class="input-field col s6">
                    <input placeholder="" id="txtMontoAbono" name="txtMontoAbono" type="text" maxlenngth="14">
                    <label for="txtMontoAbono" class="active">Monto Abono</label>
                </div>                
            </div>                                           
        </form>
    </div>
    ...
    <script src="app-assets/js/app/abonos-cuenta.js"></script>
