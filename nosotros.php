...
<div id="loading-area"></div><div class="page-wraper">
                ...
                <div class="container clearfix">
                    ...
                    <div class="header-nav navbar-collapse collapse" id="navbarNavDropdown">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"> <a href="nosotros.php">Nosotros<i class="fa fa-chevron-down"></i></a>
                            </li>
    ...
    <div class="page-content">
        <!-- inner page banner -->
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/breadcrubs-nosotros.png);">
            <div class="container">
                ...
                <div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-12 m-b30">
							<img src="images/our-services/service/nosotros.png" alt="" class="img-cover">
						</div>
