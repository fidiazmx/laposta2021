...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title> La posta - ¿Qué come el ganado?</title>
        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">¿Qué come el ganado en México?</h1>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-row">
            <div class="container">
                <ul class="list-inline">
                    <li><a href="#">Home</a></li>
                    <li>¿Qué come el ganado en México?</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb row END -->
            ...
            <div class="container">
                ...
                <div class="blog-post blog-single">
                    <div class="dez-post-title ">
                        <h3 class="post-title"><a href="#">¿Qué come el ganado en México?</a></h3>
                    </div>
