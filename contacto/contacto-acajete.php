        ...
        <div class="section-full content-inner bg-white contact-style-1">
			<div class="container">
                            ...
                            <ul class="no-margin">
                                <li class="icon-bx-wraper left m-b30">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p><?php echo utf8_encode($rowband['direccion_ubicacion']); ?></p>
                                    </div>
                                </li>
                                <li class="icon-bx-wraper left  m-b30">
				...
				<div class="row">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20609.73920517812!2d-97.02219636524745!3d19.59503246515049!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTnCsDM1JzQ2LjMiTiA5N8KwMDAnNDUuMCJX!5e0!3m2!1ses!2s!4v1502576273420" style="border:0; width:100%; height:400px;" allowfullscreen></iframe>
					<!-- Map part END -->
					</div>
				</div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="widget widget_getintuch">
                            ...
                            <div class="dez-separator bg-primary"></div>
                            <ul>
                                <li><i class="fa fa-map-marker"></i><strong>Dirección</strong><?php echo utf8_encode($rowband['direccion_ubicacion']); ?></li>
