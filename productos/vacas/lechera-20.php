...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title> La Posta - Lechera 20%</title>
        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/breadcrubs-productos.png);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Lechera 20%</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container woo-entry">
                <div class=" m-b30">
                    <div class="row blog-post blog-md date-style-2">
                        <div class="col-lg-4 col-md-4 m-b30"> <a href="#"><img src="etiqueta-lechera20.png" alt=""></a> </div>
                        <div class="col-lg-8 col-md-8">
                            <div class="dez-post-title ">
                                <h3 class="post-title m-b10"><a href="#">Lechera 20%</a></h3>
                            </div>
                        ...
                        <div class="dez-tabs border-tp product-description bg-tabs">
                            ...
                            <div class="tab-content">
                                <div id="ingredientes" class="tab-pane active">
                                    <p>Maíz rolado, sorgo molido, pastas oleaginosas, melaza, subproductos agroindustriales, vitaminas, N.N.P. y minerales.</p>        
                                </div>
                                <div id="indicaciones" class="tab-pane">
                                    <p>Ofrecer 1 kg de alimento por cada 2.5 lts de leche producidas durante toda la lactancia. Complementar con forraje de calidad.
