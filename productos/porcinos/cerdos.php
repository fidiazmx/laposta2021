								...
								<div class="col-lg-4 col-sm-12 m-b30 product-item card-container">
									<div class="dez-box">
										...
										<div class="dez-info p-a20 text-center">
											<div class="m-t15">
												<a href="../detalle-producto.php?idproducto=<?php echo $rowbdetprod['id_producto']; ?>&categoria=cerdos&producto=<?php echo $rowbdetprod['descripcion_producto']; ?>" class="site-button">Ver detalle	</a>
											</div>
										</div>									
									</div>
								</div>
