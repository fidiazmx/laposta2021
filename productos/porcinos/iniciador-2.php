...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title> La Posta - Iniciador de Cerdo 2</title>
        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/breadcrubs-productos.png);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Iniciador de Cerdo 2</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container woo-entry">
                <div class=" m-b30">
                    <div class="row blog-post blog-md date-style-2">
                        <div class="col-lg-4 col-md-4 m-b30"> <a href="#"><img src="etiqueta-iniciador2.png" alt=""></a> </div>
                        <div class="col-lg-8 col-md-8">
                            <div class="dez-post-title ">
                                <h3 class="post-title m-b10"><a href="#">Iniciador de Cerdo 2</a></h3>
                            </div>
                        ...
                        <div class="dez-tabs border-tp product-description bg-tabs">
                            ...
                            <div class="tab-content">
                                <div id="ingredientes" class="tab-pane active">
                                    <p>Cereales molidos, pastas de oleaginosas, aceite vegetal, vitaminas, minerales, aminoácidos.
                                    </p>        
                                </div>
                                <div id="indicaciones" class="tab-pane">
                                    <p>Suministrar a libre acceso en cerdos de 15 a 30 kgs de peso. Consulte al médico veterinario.</p>
                                </div>
