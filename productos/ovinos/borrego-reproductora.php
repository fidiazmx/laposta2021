...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title> La Posta - Borrego Reproductora</title>
        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/breadcrubs-productos.png);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Borrego Reproductora</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container woo-entry">
                <div class=" m-b30">
                    <div class="row blog-post blog-md date-style-2">
                        <div class="col-lg-4 col-md-4 m-b30"> <a href="#"><img src="etiqueta-borrega-reproductora.png" alt=""></a> </div>
                        <div class="col-lg-8 col-md-8">
                            <div class="dez-post-title ">
                                <h3 class="post-title m-b10"><a href="#">Borrego Reproductora</a></h3>
                            </div>
                            ...
                            <form method="post" class="cart">
                                ...
                                <button class="btn btn-primary site-button pull-left"><i class="fa fa-cart-plus"></i> Agregar al carrito</button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="dez-tabs border-tp product-description bg-tabs">
                            ...
                            <div class="tab-content">
                                <div id="ingredientes" class="tab-pane active">
                                    <p>Cereales molidos, pastas de oleaginosas, melaza, subproductos de cereales, agroindustriales y minerales.</p>        
                                </div>
                                <div id="indicaciones" class="tab-pane">
                                    <p>Para mantenimiento, ofrecer de 250 a 500 grs de alimento al día. Para Gestantes, en el último tercio de gestación, ofrecer de 500 a 750 grs. En borrega delgada o con posible parto múltiple, ofrecer 1 kg de alimento al día. Complementar con pastoreo, silo o forraje de calidad a libre acceso.
                                            ...
                                            <li class="comment">
                                                <div class="comment_container"> <img class="avatar avatar-60 photo" src="../../images/testimonials/pic1.jpg" alt="">
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta"> <strong class="author">Usuario 1</strong> <span><i class="fa fa-clock-o"></i> 11 de septiembre 2021</span> </p>
                                            ...
                                            <li class="comment">
                                                <div class="comment_container"> <img class="avatar avatar-60 photo" src="../../images/testimonials/pic2.jpg" alt="">
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta"> <strong class="author">Usuario 2</strong> <span><i class="fa fa-clock-o"></i> 11 de septiembre 2021</span> </p>
                                                        <div class="description">
                                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="comment">
                                                <div class="comment_container"> <img class="avatar avatar-60 photo" src="../../images/testimonials/pic3.jpg" alt="">
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta"> <strong class="author">Usuario 3</strong> <span><i class="fa fa-clock-o"></i> 11 de septiembre 2021</span> </p>
                                                        <div class="description">
                                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div id="review_form_wrapper">
                                        <div id="review_form">
                                            <div id="respond" class="comment-respond">
                                                <h3 class="comment-reply-title" id="reply-title">Agregar un comentario</h3>
                                                <form class="comment-form" method="post" >
                                                    ...
                                                    <div class="form-submit">
                                                        <input type="submit" value="Enviar" class="site-button" id="submit" name="submit">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
