        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/breadcrubs-productos.png);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white"><?php echo $rowProd["descripcion_producto"]; ?></h1>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-row">
            <div class="container">
                <ul class="list-inline">
					...
					<li><a href="../productos/<?php echo $_GET['categoria']; ?>/<?php echo $_GET['categoria']; ?>.php"><?php echo $_GET['categoria']; ?></a></li>
					<li><?php echo $rowProd["descripcion_producto"]; ?></li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb row END -->
                    ...
                    <div class="row blog-post blog-md date-style-2">
                        ...
                        <div class="col-lg-8 col-md-8">
                            ...
                            <table class="table table-bordered" >
                                <tr>
                                    <td>Precio</td>
                                    <td><?php echo $rowProd["precio"]; ?></td>
                                </tr>
                                <tr>
                                    <td>Stock</td>
                                    <td><?php echo $rowProd["estatus"]; ?></td>
                                </tr>
                                <!--<tr>
                                    <td>Rating</td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="widget widget_services">
                            ...
                            <div class="dez-separator bg-primary"></div>
                            <ul>
                                <li><a href="bovinos/bovinos.php">Alimento Bovinos</a></li>
                                <li><a href="porcinos/porcinos.php">Alimento Porcinos</a></li>
                                <li><a href="equinos/equinos.php">Alimento Equinos</a></li>
                                <li><a href="ovinos/ovinos.php">Alimento Ovinos</a></li>
                                <li><a href="aves/aves.php">Alimento Aves</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
