...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title> La Posta - Caballo Speed</title>
        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/breadcrubs-productos.png);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Caballo Speed</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container woo-entry">
                <div class=" m-b30">
                    <div class="row blog-post blog-md date-style-2">
                        <div class="col-lg-4 col-md-4 m-b30"> <a href="#"><img src="etiqueta-speed.png" alt=""></a> </div>
                        <div class="col-lg-8 col-md-8">
                            <div class="dez-post-title ">
                                <h3 class="post-title m-b10"><a href="#">Speed</a></h3>
                            </div>
                        ...
                        <div class="dez-tabs border-tp product-description bg-tabs">
                            ...
                            <div class="tab-content">
                                <div id="ingredientes" class="tab-pane active">
                                    <p>Cereales rolados, paletizados, pastas oleaginosas, aceite, melaza, vitaminas, minerales y levaduras.</p>        
                                </div>
                                <div id="indicaciones" class="tab-pane">
                                    <p>Si la actividad física del caballo es muy intensa, ofrezca 1 a 1.3 kgs de alimento por cada 100 kgs de peso vivo, repartido de 2 a 3 veces al día. Acompañar con forraje de calidad.
