...
<div id="loading-area"></div><div class="page-wraper">
    ...
    <div class="page-content">
        <!-- inner page banner -->
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(../../images/banner/breadcumbs-aves.png);">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-6">
						...
						<div class="row" id="masonry">
							<?php
								$querydetprod =  "SELECT id_producto, descripcion_producto, imagen_catalogo FROM productos WHERE activo = 'A' and fk_id_categoria = 5";
								...
								<div class="col-lg-4 col-sm-12 m-b30 product-item card-container">
									<div class="dez-box">
										<div class="dez-thum-bx dez-img-effect">
											<img src="../../productos/aves/<?php echo $rowbdetprod['imagen_catalogo']; ?>" alt="">
										</div>
										<div class="dez-info p-a20 text-center">
											<div class="m-t15">
												<a href="../detalle-producto.php?idproducto=<?php echo $rowbdetprod['id_producto']; ?>&categoria=aves&producto=<?php echo $rowbdetprod['descripcion_producto']; ?>" class="site-button">Ver detalle	</a>
											</div>
										</div>
									</div>
								</div>
