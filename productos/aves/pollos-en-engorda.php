...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title> La Posta - Pollos en Engorda</title>
        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/breadcrubs-productos.png);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Pollos en Engorda</h1>
                </div>
            </div>
        </div>
            ...
            <div class="container woo-entry">
                <div class=" m-b30">
                    <div class="row blog-post blog-md date-style-2">
                        <div class="col-lg-4 col-md-4 m-b30"> <a href="#"><img src="etiqueta-pollos-engorda.png" alt=""></a> </div>
                        <div class="col-lg-8 col-md-8">
                            <div class="dez-post-title ">
                                <h3 class="post-title m-b10"><a href="#">Gallina de Postura</a></h3>
                            </div>
                        ...
                        <div class="dez-tabs border-tp product-description bg-tabs">
                            ...
                            <div class="tab-content">
                                <div id="ingredientes" class="tab-pane active">
                                    <p>Cereales molidos, pastas de oleaginosas, grasa vegetal coccidiostato, fitasa, vitaminas, aminoácidos y minerales.

                                    </p>        
                                </div>
                                <div id="indicaciones" class="tab-pane">
                                    <p>Suministrar a libre acceso desde los 29 días de edad hasta finalizar la engorda. Que nunca falte agua limpia y fresca.
