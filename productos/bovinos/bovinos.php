        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(../../images/banner/breadcumbs-vacas.png);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Bovinos</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-6">
						...
						<div class="row" id="masonry">
							<?php
								$querydetprod =  "SELECT id_producto, descripcion_producto, imagen_catalogo FROM productos WHERE activo = 'A' and fk_id_categoria = 1";
								...
								<div class="col-lg-4 col-sm-12 m-b30 product-item card-container">
									<div class="dez-box">
										<div class="dez-thum-bx dez-img-effect">
											<img src="../../productos/bovinos/<?php echo $rowbdetprod['imagen_catalogo']; ?>" alt="">
										</div>
										<div class="dez-info p-a20 text-center">
											<div class="m-t15">
												<a href="../detalle-producto.php?idproducto=<?php echo $rowbdetprod['id_producto']; ?>&categoria=bovinos&producto=<?php echo $rowbdetprod['descripcion_producto']; ?>" class="site-button">Ver detalle	</a>
											</div>
										</div>
									</div>
								</div>
